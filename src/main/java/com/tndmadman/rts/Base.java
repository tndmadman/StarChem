...
final class Base {
    ...
    void draw(Graphics2D g2, Color playerColor, EnumMap<Material, Double> stockpile, boolean local) {
        ...
        s.setColor(Color.WHITE); s.drawString(label, (int)(x - tw / 2.0), (int)(y - radius - 18));
        s.dispose();
    }
}
