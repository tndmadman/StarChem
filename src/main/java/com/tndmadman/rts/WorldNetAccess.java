...
final class WorldNetAccess {
    ...
    static Snapshot snapshot(World world, long sequence) {
        List<PlayerInfo> players = List.of(new PlayerInfo("SOLO", world.localPlayerName, 0x50BEFF, true));
        ...
        List<StockState> stocks = List.of(new StockState("SOLO", CargoCodec.write(world.stockpile)));
