...
Start v1.7.0 with the same save directory and save name. The upgrade keeps save format 2, loads retained world and player state, and migrates related identity storage in place:
...
Verify the server log reports the existing save loaded, then verify the expected players, research, ships, stations, inventories, production queues, controlled systems, and remote systems before allowing normal play.
...
- v1.6.0 and v1.7.0 multiplayer protocols are intentionally incompatible.
