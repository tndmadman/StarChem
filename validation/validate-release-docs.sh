...
# Remote-registration authorization is separate from network identity. The real socket
# address remains authoritative for rate limiting, moderation, auditing, and admission.
require_text src/main/java/com/tndmadman/rts/SideAJoin.java 'boolean remoteRegistration = RemoteRegistrationBridge.allowed(server, name, realAddress);'
...
require_text src/main/java/com/tndmadman/rts/SideAJoin.java 'remoteRegistration);'
require_text src/main/java/com/tndmadman/rts/RemoteRegistrationBridge.java '!realAddress.isLoopbackAddress()'
...
reject_text src/main/java/com/tndmadman/rts/RemoteRegistrationBridge.java 'InetAddress.getLoopbackAddress()'
reject_text src/main/java/com/tndmadman/rts/SideAJoin.java 'RemoteRegistrationBridge.select('
reject_text src/main/java/com/tndmadman/rts/SideAJoin.java 'RemoteRegistrationBridge.restoreRealAddress('
